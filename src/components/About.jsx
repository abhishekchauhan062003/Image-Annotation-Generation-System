  ...
  <div className="card card-all container my-5" style={{top: "2.5rem"}}>
    ...
    <div className="card-body">
      ...
      <img className="rounded-circle" src={myPhoto} alt="Generic placeholder image" width="120" height="120" style={img}/>
      </div>
      <div class="col">
    ...
    <div className="card-body">
      ...
      <div class="row">
      <div class="col col-md-auto">
      <img className="rounded-circle" src={Ashutosh} alt="Generic placeholder image" width="120" height="120" style={img}/>
      </div>
      <div class="col">
    ...
    <div className="card-body">
      ...
      <div class="row">
      <div class="col col-md-auto">
      <img className="rounded-circle" src={Lokesh} alt="Generic placeholder image" width="120" height="120" style={img}/>
      </div>
      <div class="col">
